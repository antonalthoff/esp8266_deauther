...
bool APScan::start() {
  ...
  results = WiFi.scanNetworks();  // Commented this part out and used the Default WiFi.scanNetworks function if it doesnt detect any Wifi--->(settings.apScanHidden); // lets scanNetworks return hidden APs. (async = false & show_hidden = true)
